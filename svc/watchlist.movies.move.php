...
//if(!empty($session_id)) {
			...
			$query ="Update  watchlistmovies w join userwatchlists u on w.userwatchlist_id=u.userwatchlist_id set w.userwatchlist_id = ".$userwatchlist_id." where w.watchlistmovies_id=".$watchlistmovies_id." and u.user_id=".$LoggedInResponse->user_id;
			//echo $query."<br>";
